...
public class CommentServiceJDBC implements CommentService {
    private static final String CREATE_STATEMENT = "CREATE TABLE comment (game VARCHAR(64) NOT NULL" +
            ", player VARCHAR(64) NOT NULL, comment VARCHAR(255) NOT NULL , comented_at TIMESTAMP WITHOUT TIME ZONE NOT NULL )";
    public static final String SELECT = "SELECT game, player, comment, commented_at FROM comment WHERE game = ? ORDER BY commented_at";
